package net.yezon.theabyss.configuredfeature;
...
import net.yezon.theabyss.configuredfeature.AbyssDungeon;
import net.yezon.theabyss.configuredfeature.ForestHutDungeon;
...
public class STStructures {
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> RUN_DOWN_HOUSE = DEFERRED_REGISTRY_STRUCTURE.register("abyss_dungeon", () -> (new AbyssDungeon(NoFeatureConfig.field_236558_a_)));
	public static final RegistryObject<Structure<NoFeatureConfig>> FOREST_HUT = DEFERRED_REGISTRY_STRUCTURE.register("forest_hut", () -> (new ForestHutDungeon(NoFeatureConfig.field_236558_a_)));
    /**
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                ...
                new StructureSeparationSettings(24 /* average distance apart in chunks between spawn attempts */,
                        ...
                        1234527834 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);

                        setupMapSpacingAndLand(
                FOREST_HUT.get(), /* The instance of the structure */
                new StructureSeparationSettings(24 /* average distance apart in chunks between spawn attempts */,
                        9 /* minimum distance apart in chunks between spawn attempts */,
                        1754254893 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
