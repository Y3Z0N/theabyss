...
import net.yezon.theabyss.AbyssDungeon;
import net.yezon.theabyss.CastleDungeon;
import net.yezon.theabyss.ForestHutDungeon;
import net.yezon.theabyss.AbylagerHut;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

public class STStructuresLand {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, "theabyss");
     ...
     */
	public static final RegistryObject<Structure<NoFeatureConfig>> CASTLE = DEFERRED_REGISTRY_STRUCTURE.register("castle", () -> (new CastleDungeon(NoFeatureConfig.field_236558_a_)));
	public static final RegistryObject<Structure<NoFeatureConfig>> ABYLAGER_HUT = DEFERRED_REGISTRY_STRUCTURE.register("abylager_hut", () -> (new AbylagerHut(NoFeatureConfig.field_236558_a_)));
    /**
    /**
    ...
    public static void setupStructures() {
                 ...
                 CASTLE.get(), /* The instance of the structure */
                new StructureSeparationSettings(24 /* average distance apart in chunks between spawn attempts */,
                        ...
                        1134127134 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
                        setupMapSpacingAndLand(     
                 ABYLAGER_HUT.get(), /* The instance of the structure */
                new StructureSeparationSettings(24 /* average distance apart in chunks between spawn attempts */,
                        9 /* minimum distance apart in chunks between spawn attempts */,
                        1232122334 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
