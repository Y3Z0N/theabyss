...
public class SlimedFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_fence_gate")
	public static final Block block = null;

	public SlimedFenceGateBlock(TheAbyss instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("slimed_fence_gate");
		}
