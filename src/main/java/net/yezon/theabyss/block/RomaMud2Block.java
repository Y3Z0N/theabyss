...
public class RomaMud2Block extends TheAbyss.Processor {
	@ObjectHolder("theabyss:roma_mud_2")
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == RomaMudBlock.block)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("theabyss:roma_mud_2_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("roma_mud_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:roma_mud_2"), configuredFeature);
		}
	}
