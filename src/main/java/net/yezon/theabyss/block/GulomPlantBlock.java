...
public class GulomPlantBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:gulom_plant")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("gulom_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:gulom_plant"), configuredFeature);
		}
	}
