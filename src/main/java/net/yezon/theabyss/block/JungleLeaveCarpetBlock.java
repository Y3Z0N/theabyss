...
public class JungleLeaveCarpetBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_leave_carpet")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jungle_leave_carpet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:jungle_leave_carpet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("jungle_leave_carpet");
		}
