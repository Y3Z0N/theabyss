...
public class SlimedSlabBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_slab")
	public static final Block block = null;

	public SlimedSlabBlock(TheAbyss instance) {
		super(instance, 319);
	}
