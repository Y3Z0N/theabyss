...
public class HollowCrystalOreBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:hollow_crystal_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hollow_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:hollow_crystal_ore"), configuredFeature);
		}
	}
		...
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							...
							.setLightLevel(s -> 3));
			setRegistryName("hollow_crystal_ore");
		}
