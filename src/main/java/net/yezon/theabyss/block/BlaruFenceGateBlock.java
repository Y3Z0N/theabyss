...
public class BlaruFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_fence_gate")
	public static final Block block = null;

	public BlaruFenceGateBlock(TheAbyss instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blaru_fence_gate");
		}
