...
public class ResearchTableBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:research_table")
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("research_table"));
		}
	}
