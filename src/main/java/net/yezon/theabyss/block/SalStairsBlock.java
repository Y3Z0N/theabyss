...
public class SalStairsBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:sal_stairs")
	public static final Block block = null;

	public SalStairsBlock(TheAbyss instance) {
		super(instance, 313);
	}
