...
public class MiniStone1Block extends TheAbyss.Processor {
	@ObjectHolder("theabyss:mini_stone_1")
	public static final Block block = null;

	public MiniStone1Block(TheAbyss instance) {
		super(instance, 479);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("mini_stone_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:mini_stone_1"), configuredFeature);
		}
	}
