...
public class JungleVineBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_vine")
	public static final Block block = null;

	public JungleVineBlock(TheAbyss instance) {
		super(instance, 502);
	}
