...
public class LoranBush2Block extends TheAbyss.Processor {
	@ObjectHolder("theabyss:loran_bush_2")
	public static final Block block = null;

	public LoranBush2Block(TheAbyss instance) {
		super(instance, 452);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("loran_bush_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:loran_bush_2"), configuredFeature);
		}
	}
