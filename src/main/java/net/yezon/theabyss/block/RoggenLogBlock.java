...
public class RoggenLogBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:roggen_log")
	public static final Block block = null;

	public RoggenLogBlock(TheAbyss instance) {
		super(instance, 262);
	}
