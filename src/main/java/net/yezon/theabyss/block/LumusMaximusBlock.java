...
public class LumusMaximusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:lumus_maximus")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lumus_maximus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:lumus_maximus"), configuredFeature);
		}
	}
