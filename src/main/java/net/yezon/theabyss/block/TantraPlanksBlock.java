...
public class TantraPlanksBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_planks")
	public static final Block block = null;

	public TantraPlanksBlock(TheAbyss instance) {
		super(instance, 278);
	}
