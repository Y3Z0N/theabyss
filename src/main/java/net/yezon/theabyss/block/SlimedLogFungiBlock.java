...
public class SlimedLogFungiBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_log_fungi")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.CORAL).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 3)
			...
			setRegistryName("slimed_log_fungi");
		}
