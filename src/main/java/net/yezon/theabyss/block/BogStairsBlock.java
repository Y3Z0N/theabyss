...
public class BogStairsBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bog_stairs")
	public static final Block block = null;

	public BogStairsBlock(TheAbyss instance) {
		super(instance, 300);
	}
