...
public class SlimedVitaeBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_vitae")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("slimed_vitae"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:slimed_vitae"), configuredFeature);
		}
	}
