...
public class LumusFlowerBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:lumus_flower")
	public static final Block block = null;

	public LumusFlowerBlock(TheAbyss instance) {
		super(instance, 498);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lumus_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:lumus_flower"), configuredFeature);
		}
	}
