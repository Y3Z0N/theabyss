...
public class BoneThinBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bone_thin")
	...
	public static class CustomBlock extends WallBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BrokenBoneItem.block));
		}
	}
}
