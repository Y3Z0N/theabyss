...
public class SlimedFenceBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_fence")
	public static final Block block = null;

	public SlimedFenceBlock(TheAbyss instance) {
		super(instance, 322);
	}
