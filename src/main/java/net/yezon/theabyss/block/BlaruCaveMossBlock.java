...
public class BlaruCaveMossBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_cave_moss")
	public static final Block block = null;

	public BlaruCaveMossBlock(TheAbyss instance) {
		super(instance, 534);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blaru_cave_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:blaru_cave_moss"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blaru_cave_moss");
		}
