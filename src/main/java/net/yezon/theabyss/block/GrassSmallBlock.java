...
public class GrassSmallBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:grass_small")
	public static final Block block = null;

	public GrassSmallBlock(TheAbyss instance) {
		super(instance, 464);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grass_small"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:grass_small"), configuredFeature);
		}
	}
