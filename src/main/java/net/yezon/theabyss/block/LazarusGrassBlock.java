...
public class LazarusGrassBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:lazarus_grass")
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			configuredFeature = feature.withConfiguration(
					(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(block.getDefaultState()), new SimpleBlockPlacer())).tries(64)
							.build())
					.withPlacement(Placement.COUNT_NOISE.configure(new NoiseDependant(-0.8, 0, 6)));
			event.getRegistry().register(feature.setRegistryName("lazarus_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:lazarus_grass"), configuredFeature);
		}
	}
