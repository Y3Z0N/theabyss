...
public class OpiaShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:opia_shroom")
	public static final Block block = null;

	public OpiaShroomBlock(TheAbyss instance) {
		super(instance, 450);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("opia_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:opia_shroom"), configuredFeature);
		}
	}
