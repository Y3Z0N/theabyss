...
public class TantraFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_fence_gate")
	public static final Block block = null;

	public TantraFenceGateBlock(TheAbyss instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tantra_fence_gate");
		}
