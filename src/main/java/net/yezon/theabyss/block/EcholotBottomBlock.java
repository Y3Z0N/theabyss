...
public class EcholotBottomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:echolot_bottom")
	public static final Block block = null;

	public EcholotBottomBlock(TheAbyss instance) {
		super(instance, 631);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("echolot_bottom");
		}
