...
public class LungoRankBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:lungo_rank")
	public static final Block block = null;

	public LungoRankBlock(TheAbyss instance) {
		super(instance, 528);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lungo_rank"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:lungo_rank"), configuredFeature);
		}
	}
