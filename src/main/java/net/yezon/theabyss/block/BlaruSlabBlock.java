...
public class BlaruSlabBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_slab")
	public static final Block block = null;

	public BlaruSlabBlock(TheAbyss instance) {
		super(instance, 229);
	}
