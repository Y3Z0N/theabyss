...
public class WartRootBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:wart_root")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("wart_root"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:wart_root"), configuredFeature);
		}
	}
