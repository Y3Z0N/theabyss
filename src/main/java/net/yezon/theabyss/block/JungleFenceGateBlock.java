...
public class JungleFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_fence_gate")
	public static final Block block = null;

	public JungleFenceGateBlock(TheAbyss instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_fence_gate");
		}
