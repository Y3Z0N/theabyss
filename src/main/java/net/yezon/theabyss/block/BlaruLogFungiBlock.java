...
public class BlaruLogFungiBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_log_fungi")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.CORAL).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 1)
			...
			setRegistryName("blaru_log_fungi");
		}
