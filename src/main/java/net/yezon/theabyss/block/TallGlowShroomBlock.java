...
public class TallGlowShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tall_glow_shroom")
	public static final Block block = null;

	public TallGlowShroomBlock(TheAbyss instance) {
		super(instance, 479);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tall_glow_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:tall_glow_shroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("tall_glow_shroom");
		}
