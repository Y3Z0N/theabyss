...
public class BogShroomLeaveBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bog_shroom_leave")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.3f, 5f).setLightLevel(s -> 4).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("bog_shroom_leave");
		}
