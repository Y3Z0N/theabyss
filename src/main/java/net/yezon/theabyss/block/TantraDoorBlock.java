...
public class TantraDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_door")
	public static final Block block = null;

	public TantraDoorBlock(TheAbyss instance) {
		super(instance, 290);
	}
