...
public class BogTrapDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bog_trap_door")
	public static final Block block = null;

	public BogTrapDoorBlock(TheAbyss instance) {
		super(instance, 294);
	}
