...
public class JungleFenceBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_fence")
	public static final Block block = null;

	public JungleFenceBlock(TheAbyss instance) {
		super(instance, 247);
	}
