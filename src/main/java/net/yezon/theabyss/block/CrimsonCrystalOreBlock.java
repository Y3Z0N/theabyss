...
public class CrimsonCrystalOreBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:crimson_crystal_ore")
	public static final Block block = null;

	public CrimsonCrystalOreBlock(TheAbyss instance) {
		super(instance, 515);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("crimson_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:crimson_crystal_ore"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							...
							.setLightLevel(s -> 3));
			setRegistryName("crimson_crystal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrimsonCrystalOreBlock.block));
		}
