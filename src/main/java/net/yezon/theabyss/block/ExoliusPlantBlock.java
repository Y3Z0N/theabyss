...
public class ExoliusPlantBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:exolius_plant")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("exolius_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:exolius_plant"), configuredFeature);
		}
	}
