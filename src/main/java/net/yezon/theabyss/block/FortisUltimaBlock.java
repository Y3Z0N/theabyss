...
public class FortisUltimaBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:fortis_ultima")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("fortis_ultima"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:fortis_ultima"), configuredFeature);
		}
	}
