...
public class TeslaRankBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tesla_rank")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tesla_rank"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:tesla_rank"), configuredFeature);
		}
	}
