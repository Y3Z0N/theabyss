...
public class BogFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bog_fence_gate")
	public static final Block block = null;

	public BogFenceGateBlock(TheAbyss instance) {
		super(instance, 305);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bog_fence_gate");
		}
