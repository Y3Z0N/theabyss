...
public class StrippedRoggenLogBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stripped_roggen_log")
	public static final Block block = null;

	public StrippedRoggenLogBlock(TheAbyss instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_roggen_log");
		}
