...
public class EnderCrystalOreBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ender_crystal_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ender_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:ender_crystal_ore"), configuredFeature);
		}
	}
		...
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							...
							.setLightLevel(s -> 3));
			setRegistryName("ender_crystal_ore");
		}
