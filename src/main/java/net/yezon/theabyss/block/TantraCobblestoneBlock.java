...
public class TantraCobblestoneBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_cobblestone")
	public static final Block block = null;

	public TantraCobblestoneBlock(TheAbyss instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tantra_cobblestone");
		}
