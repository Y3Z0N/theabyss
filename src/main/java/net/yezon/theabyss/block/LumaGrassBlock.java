...
public class LumaGrassBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:luma_grass")
	public static final Block block = null;

	public LumaGrassBlock(TheAbyss instance) {
		super(instance, 638);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("luma_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:luma_grass"), configuredFeature);
		}
	}
