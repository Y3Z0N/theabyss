...
public class YoungExoliusPlantBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:young_exolius_plant")
	public static final Block block = null;

	public YoungExoliusPlantBlock(TheAbyss instance) {
		super(instance, 524);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("young_exolius_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:young_exolius_plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("young_exolius_plant");
		}
