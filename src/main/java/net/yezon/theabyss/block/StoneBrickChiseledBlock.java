...
public class StoneBrickChiseledBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stone_brick_chiseled")
	public static final Block block = null;

	public StoneBrickChiseledBlock(TheAbyss instance) {
		super(instance, 349);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_brick_chiseled");
		}
