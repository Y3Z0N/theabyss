...
public class CobbleStoneWallBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:cobble_stone_wall")
	public static final Block block = null;

	public CobbleStoneWallBlock(TheAbyss instance) {
		super(instance, 344);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cobble_stone_wall");
		}
