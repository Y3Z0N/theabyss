...
public class StrippedTantraLogBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stripped_tantra_log")
	public static final Block block = null;

	public StrippedTantraLogBlock(TheAbyss instance) {
		super(instance, 285);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 9.5f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("stripped_tantra_log");
		}
