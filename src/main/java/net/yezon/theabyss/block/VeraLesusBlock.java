...
public class VeraLesusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:vera_lesus")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("vera_lesus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:vera_lesus"), configuredFeature);
		}
	}
