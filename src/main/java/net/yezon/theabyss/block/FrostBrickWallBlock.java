...
public class FrostBrickWallBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frost_brick_wall")
	public static final Block block = null;

	public FrostBrickWallBlock(TheAbyss instance) {
		super(instance, 354);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_brick_wall");
		}
