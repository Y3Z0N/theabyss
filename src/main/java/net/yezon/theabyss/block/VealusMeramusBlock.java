...
import net.yezon.theabyss.events.VealusMeramusCollideEvent;
...
public class VealusMeramusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:vealus_meramus")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("vealus_meramus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:vealus_meramus"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("vealus_meramus");
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			VealusMeramusCollideEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
