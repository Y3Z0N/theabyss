...
public class DiamondVariantBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:diamond_variant")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diamond_variant");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("theabyss:diamond_variant_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("diamond_variant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:diamond_variant"), configuredFeature);
		}
	}
