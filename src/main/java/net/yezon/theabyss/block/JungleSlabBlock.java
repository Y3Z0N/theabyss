...
public class JungleSlabBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_slab")
	public static final Block block = null;

	public JungleSlabBlock(TheAbyss instance) {
		super(instance, 244);
	}
