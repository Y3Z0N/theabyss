...
public class JungleDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:jungle_door")
	public static final Block block = null;

	public JungleDoorBlock(TheAbyss instance) {
		super(instance, 238);
	}
