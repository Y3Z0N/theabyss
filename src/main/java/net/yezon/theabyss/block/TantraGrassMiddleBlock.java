...
public class TantraGrassMiddleBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_grass_middle")
	public static final Block block = null;

	public TantraGrassMiddleBlock(TheAbyss instance) {
		super(instance, 507);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tantra_grass_middle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:tantra_grass_middle"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("tantra_grass_middle");
		}
