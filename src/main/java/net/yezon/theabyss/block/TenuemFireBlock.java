...
public class TenuemFireBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tenuem_fire")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tenuem_fire"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:tenuem_fire"), configuredFeature);
		}
	}
