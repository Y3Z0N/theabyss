...
public class TantraSlabBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_slab")
	public static final Block block = null;

	public TantraSlabBlock(TheAbyss instance) {
		super(instance, 288);
	}
