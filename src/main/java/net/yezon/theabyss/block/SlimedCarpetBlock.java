...
public class SlimedCarpetBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_carpet")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("slimed_carpet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:slimed_carpet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.SLIME)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("slimed_carpet");
		}
