...
public class GlowingBlaruMossBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:glowing_blaru_moss")
	public static final Block block = null;

	public GlowingBlaruMossBlock(TheAbyss instance) {
		super(instance, 529);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:glowing_blaru_moss"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("glowing_blaru_moss");
		}
