...
public class StoneBrickPillarIgnitedBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stone_brick_pillar_ignited")
	public static final Block block = null;

	public StoneBrickPillarIgnitedBlock(TheAbyss instance) {
		super(instance, 354);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 10f).setLightLevel(s -> 15).harvestLevel(1)
			...
			setRegistryName("stone_brick_pillar_ignited");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StoneBrickPillarBlock.block));
		}
