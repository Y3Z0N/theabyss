...
public class FlosVitaeBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:flos_vitae")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					for (int j = 0; j < 8; ++j) {
						...
						if (world.isAirBlock(blockpos)) {
							...
							int k = 1 + random.nextInt(random.nextInt(13) + 1);
							k = Math.min(13, k);
							for (int l = 0; l < k; ++l) {
			...
			event.getRegistry().register(feature.setRegistryName("flos_vitae"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:flos_vitae"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("this plant can cure you for a short time!"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(VitaeDustItem.block));
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			HealFlowerEffectEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
