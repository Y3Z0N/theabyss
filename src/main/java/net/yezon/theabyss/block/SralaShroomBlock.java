...
public class SralaShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:srala_shroom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("srala_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:srala_shroom"), configuredFeature);
		}
	}
