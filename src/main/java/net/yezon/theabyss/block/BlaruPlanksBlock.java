...
public class BlaruPlanksBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_planks")
	public static final Block block = null;

	public BlaruPlanksBlock(TheAbyss instance) {
		super(instance, 219);
	}
