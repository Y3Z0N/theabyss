...
public class FrozenDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frozen_door")
	public static final Block block = null;

	public FrozenDoorBlock(TheAbyss instance) {
		super(instance, 342);
	}
