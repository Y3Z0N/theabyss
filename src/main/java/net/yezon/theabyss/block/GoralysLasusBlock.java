...
public class GoralysLasusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:goralys_lasus")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("goralys_lasus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:goralys_lasus"), configuredFeature);
		}
	}
