...
public class WaterEcholotMiddleBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:water_echolot_middle")
	public static final Block block = null;

	public WaterEcholotMiddleBlock(TheAbyss instance) {
		super(instance, 1167);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("water_echolot_middle");
		}
