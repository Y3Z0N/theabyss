...
public class TallRubShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tall_rub_shroom")
	public static final Block block = null;

	public TallRubShroomBlock(TheAbyss instance) {
		super(instance, 469);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tall_rub_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:tall_rub_shroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("tall_rub_shroom");
		}
