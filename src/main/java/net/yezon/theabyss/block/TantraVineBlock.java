...
public class TantraVineBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_vine")
	public static final Block block = null;

	public TantraVineBlock(TheAbyss instance) {
		super(instance, 481);
	}
