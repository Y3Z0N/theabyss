...
public class RottenRankBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:rotten_rank")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rotten_rank"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:rotten_rank"), configuredFeature);
		}
	}
