...
public class RaptorEggBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:raptor_egg")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("raptor_egg"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:raptor_egg"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			RaptorEggEventEvent.executeEvent(Stream
