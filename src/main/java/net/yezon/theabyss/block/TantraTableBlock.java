...
public class TantraTableBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_table")
	public static final Block block = null;

	public TantraTableBlock(TheAbyss instance) {
		super(instance, 288);
	}
