...
public class ArenoBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:areno")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("theabyss:areno_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public ArenoBlock(TheAbyss instance) {
		super(instance, 373);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("theabyss:blocks/areno"), new ResourceLocation("theabyss:blocks/areno")).luminosity(0)
						.density(500).viscosity(500).temperature(300).gaseous().rarity(Rarity.COMMON)).explosionResistance(100f)

								.tickRate(5).levelDecreasePerBlock(1).slopeFindDistance(4).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("areno");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("areno_flowing");
		...
		}.setRegistryName("areno"));
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(TheAbyssItemGroup.tab).rarity(Rarity.COMMON))
						.setRegistryName("areno_bucket"));
	}
	...
	public static abstract class CustomFlowingFluid extends ForgeFlowingFluid {
		...
		public IParticleData getDripParticleData() {
			return RenderCyanParticle.particle;
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("areno_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:areno_lakes"), configuredFeature);
		}
	}
