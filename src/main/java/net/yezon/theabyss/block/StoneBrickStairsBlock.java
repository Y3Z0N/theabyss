...
public class StoneBrickStairsBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stone_brick_stairs")
	public static final Block block = null;

	public StoneBrickStairsBlock(TheAbyss instance) {
		super(instance, 346);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stone_brick_stairs");
		}
