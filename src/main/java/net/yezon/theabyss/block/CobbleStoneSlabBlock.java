...
public class CobbleStoneSlabBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:cobble_stone_slab")
	public static final Block block = null;

	public CobbleStoneSlabBlock(TheAbyss instance) {
		super(instance, 359);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cobble_stone_slab");
		}
