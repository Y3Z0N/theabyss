...
public class StoneStairsBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:stone_stairs")
	public static final Block block = null;

	public StoneStairsBlock(TheAbyss instance) {
		super(instance, 1328);
	}
