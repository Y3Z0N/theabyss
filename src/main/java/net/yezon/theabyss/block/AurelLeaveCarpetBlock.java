...
public class AurelLeaveCarpetBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aurel_leave_carpet")
	public static final Block block = null;

	public AurelLeaveCarpetBlock(TheAbyss instance) {
		super(instance, 532);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aurel_leave_carpet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:aurel_leave_carpet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("aurel_leave_carpet");
		}
