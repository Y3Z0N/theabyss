...
public class BlaruLeaveCarpetBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_leave_carpet")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blaru_leave_carpet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:blaru_leave_carpet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blaru_leave_carpet");
		}
