...
public class BlaruChairBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_chair")
	public static final Block block = null;

	public BlaruChairBlock(TheAbyss instance) {
		super(instance, 237);
	}
