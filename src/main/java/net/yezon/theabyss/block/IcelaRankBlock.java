...
public class IcelaRankBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:icela_rank")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("icela_rank"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:icela_rank"), configuredFeature);
		}
	}
