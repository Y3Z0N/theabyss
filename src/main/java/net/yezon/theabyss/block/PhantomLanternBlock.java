...
public class PhantomLanternBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:phantom_lantern")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phantom_lantern");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			PhantomLanternCheckEvent.executeEvent(Stream
