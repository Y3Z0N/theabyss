...
public class OctavysMagynisiusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:octavys_magynisius")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("octavys_magynisius"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:octavys_magynisius"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("octavys_magynisius");
		}
