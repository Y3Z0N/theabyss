...
public class NightAltarActivatedBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:night_altar_activated")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("night_altar_activated");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			NightAltarSummonCheckEvent.executeEvent(Collections.EMPTY_MAP);
