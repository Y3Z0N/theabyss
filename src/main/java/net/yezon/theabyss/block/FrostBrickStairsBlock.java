...
public class FrostBrickStairsBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frost_brick_stairs")
	public static final Block block = null;

	public FrostBrickStairsBlock(TheAbyss instance) {
		super(instance, 379);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_brick_stairs");
		}
