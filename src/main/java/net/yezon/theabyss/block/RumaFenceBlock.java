...
public class RumaFenceBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ruma_fence")
	public static final Block block = null;

	public RumaFenceBlock(TheAbyss instance) {
		super(instance, 262);
	}
