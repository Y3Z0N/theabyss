...
public class RumaFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ruma_fence_gate")
	public static final Block block = null;

	public RumaFenceGateBlock(TheAbyss instance) {
		super(instance, 255);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ruma_fence_gate");
		}
