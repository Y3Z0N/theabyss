...
public class TantraFenceBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_fence")
	public static final Block block = null;

	public TantraFenceBlock(TheAbyss instance) {
		super(instance, 291);
	}
