...
public class SlimedPlanksBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:slimed_planks")
	public static final Block block = null;

	public SlimedPlanksBlock(TheAbyss instance) {
		super(instance, 325);
	}
