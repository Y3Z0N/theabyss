...
public class LumusGrassBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:lumus_grass")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lumus_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:lumus_grass"), configuredFeature);
		}
	}
