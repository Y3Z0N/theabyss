...
public class RoggenFenceGateBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:roggen_fence_gate")
	public static final Block block = null;

	public RoggenFenceGateBlock(TheAbyss instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("roggen_fence_gate");
		}
