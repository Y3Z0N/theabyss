...
public class HoglinLanternBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:hoglin_lantern")
	public static final Block block = null;

	public HoglinLanternBlock(TheAbyss instance) {
		super(instance, 358);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hoglin_lantern");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(6, 0, 6, 10, 9, 10), makeCuboidShape(5, 0, 5, 11, 7, 11)
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			HoglinLanternCheckEvent.executeEvent(Stream
