...
public class AbyssCrystalOreBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:abyss_crystal_ore")
	public static final Block block = null;

	public AbyssCrystalOreBlock(TheAbyss instance) {
		super(instance, 521);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("abyss_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:abyss_crystal_ore"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AbyssCrystalOreBlock.block));
		}

		@Override
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			Block ground = state.getBlock();
			return (ground == InfectedGrassBlock.block || ground == StoneBlock.block
