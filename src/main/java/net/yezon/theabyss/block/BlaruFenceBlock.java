...
public class BlaruFenceBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_fence")
	public static final Block block = null;

	public BlaruFenceBlock(TheAbyss instance) {
		super(instance, 232);
	}
