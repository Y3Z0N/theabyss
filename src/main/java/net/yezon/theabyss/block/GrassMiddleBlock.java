...
public class GrassMiddleBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:grass_middle")
	public static final Block block = null;

	public GrassMiddleBlock(TheAbyss instance) {
		super(instance, 465);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grass_middle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:grass_middle"), configuredFeature);
		}
	}
