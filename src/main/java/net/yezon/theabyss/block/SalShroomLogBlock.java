...
public class SalShroomLogBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:sal_shroom_log")
	public static final Block block = null;

	public SalShroomLogBlock(TheAbyss instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sal_shroom_log");
		}
