...
public class HealCampFireBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:heal_camp_fire")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("heal_camp_fire");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			HealFireEvent.executeEvent(Stream
