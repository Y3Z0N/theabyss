...
public class RikomiVersaBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:rikomi_versa")
	public static final Block block = null;

	public RikomiVersaBlock(TheAbyss instance) {
		super(instance, 451);
	}
