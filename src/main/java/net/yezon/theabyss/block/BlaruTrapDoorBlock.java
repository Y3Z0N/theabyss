...
public class BlaruTrapDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:blaru_trap_door")
	public static final Block block = null;

	public BlaruTrapDoorBlock(TheAbyss instance) {
		super(instance, 230);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blaru_trap_door");
		}
