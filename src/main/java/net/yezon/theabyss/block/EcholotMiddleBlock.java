...
public class EcholotMiddleBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:echolot_middle")
	public static final Block block = null;

	public EcholotMiddleBlock(TheAbyss instance) {
		super(instance, 630);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("echolot_middle");
		}
