...
public class FrostBrickBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frost_brick")
	public static final Block block = null;

	public FrostBrickBlock(TheAbyss instance) {
		super(instance, 350);
	}
