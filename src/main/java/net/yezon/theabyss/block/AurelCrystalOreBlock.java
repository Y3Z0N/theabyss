...
public class AurelCrystalOreBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aurel_crystal_ore")
	public static final Block block = null;

	public AurelCrystalOreBlock(TheAbyss instance) {
		super(instance, 517);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aurel_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:aurel_crystal_ore"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							...
							.setLightLevel(s -> 3));
			setRegistryName("aurel_crystal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AurelCrystalOreBlock.block));
		}
