...
public class LoranBushBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:loran_bush")
	public static final Block block = null;

	public LoranBushBlock(TheAbyss instance) {
		super(instance, 465);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("loran_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:loran_bush"), configuredFeature);
		}
	}
