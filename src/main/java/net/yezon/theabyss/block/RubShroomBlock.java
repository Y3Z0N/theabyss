...
public class RubShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:rub_shroom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rub_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:rub_shroom"), configuredFeature);
		}
	}
