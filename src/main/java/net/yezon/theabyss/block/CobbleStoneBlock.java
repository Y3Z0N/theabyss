...
public class CobbleStoneBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:cobble_stone")
	public static final Block block = null;

	public CobbleStoneBlock(TheAbyss instance) {
		super(instance, 361);
	}
