...
public class AurelCaveMossBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aurel_cave_moss")
	public static final Block block = null;

	public AurelCaveMossBlock(TheAbyss instance) {
		super(instance, 530);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("aurel_cave_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:aurel_cave_moss"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("aurel_cave_moss");
		}
