...
public class GlowShroomBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:glow_shroom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glow_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:glow_shroom"), configuredFeature);
		}
	}
