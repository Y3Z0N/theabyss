...
public class GrassBigBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:grass_big")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grass_big"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:grass_big"), configuredFeature);
		}
	}
