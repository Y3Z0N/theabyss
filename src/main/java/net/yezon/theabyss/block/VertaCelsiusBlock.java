...
public class VertaCelsiusBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:verta_celsius")
	public static final Block block = null;

	public VertaCelsiusBlock(TheAbyss instance) {
		super(instance, 483);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("verta_celsius"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:verta_celsius"), configuredFeature);
		}
	}
