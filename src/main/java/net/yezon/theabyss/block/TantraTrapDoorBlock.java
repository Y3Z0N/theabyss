...
public class TantraTrapDoorBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tantra_trap_door")
	public static final Block block = null;

	public TantraTrapDoorBlock(TheAbyss instance) {
		super(instance, 281);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("tantra_trap_door");
		}
