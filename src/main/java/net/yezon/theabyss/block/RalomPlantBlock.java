...
public class RalomPlantBlock extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ralom_plant")
	public static final Block block = null;

	public RalomPlantBlock(TheAbyss instance) {
		super(instance, 435);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ralom_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:ralom_plant"), configuredFeature);
		}
	}
