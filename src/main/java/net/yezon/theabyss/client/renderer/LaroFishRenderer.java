...
public class LaroFishRenderer extends MobRenderer<LaroFishEntity, Modelfish1<LaroFishEntity>> {
	public LaroFishRenderer(EntityRendererProvider.Context context) {
