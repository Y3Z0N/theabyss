...
public class ExtractorScreen extends AbstractContainerScreen<ExtractorMenu> {
	private final static HashMap<String, Object> guistate = ExtractorMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ExtractorScreen(ExtractorMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("theabyss:textures/screens/extractor_gui.png"));
