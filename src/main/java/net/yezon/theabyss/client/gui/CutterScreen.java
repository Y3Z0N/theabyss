...
public class CutterScreen extends AbstractContainerScreen<CutterMenu> {
	private final static HashMap<String, Object> guistate = CutterMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CutterScreen(CutterMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("theabyss:textures/screens/crystalcutter_gui.png"));
