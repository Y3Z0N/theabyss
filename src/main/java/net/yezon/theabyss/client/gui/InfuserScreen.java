...
public class InfuserScreen extends AbstractContainerScreen<InfuserMenu> {
	private final static HashMap<String, Object> guistate = InfuserMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("theabyss:textures/screens/infuser.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("theabyss:textures/screens/somnium_infuser_gui.png"));
