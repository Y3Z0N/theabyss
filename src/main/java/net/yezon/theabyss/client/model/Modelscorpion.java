...
public class Modelscorpion<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = right_leg4.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 0).addBox(-4.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(33, 34)
						.addBox(-4.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = right_leg3.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 17)
						.addBox(-4.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = right_leg2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(25, 0).addBox(-4.5F, 0.5F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 36)
						.addBox(-4.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = right_leg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(4, 17).addBox(-4.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = right_leg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(25, 11).addBox(-4.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = left_leg4.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 38).addBox(-1.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 0)
						.addBox(3.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.3834F, -0.5F, 2.974F, 0.1703F, -0.5218F, -0.3882F));
		...
		PartDefinition cube_r7 = left_leg3.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 17).addBox(3.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 14)
						.addBox(-1.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = left_leg2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(29, 0).addBox(3.5F, 0.5F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(38, 12)
						.addBox(-1.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.3834F, -5.5F, 0.974F, 0.0131F, 0.2114F, -0.2061F));
		...
		PartDefinition cube_r9 = left_leg.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(28, 40).addBox(3.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = left_leg.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(36, 38).addBox(-1.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.3834F, -5.5F, -1.026F, -0.0607F, 0.5296F, -0.158F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -7.0F, -5.0F, 6.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition cube_r11 = body.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(19, 20).addBox(1.0F, -2.0682F, -1.1901F, 2.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = body.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(2, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = body.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 31).addBox(1.0F, -4.5432F, 8.8325F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = body.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(19, 19).addBox(0.5F, -1.5432F, 8.3325F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -19.8576F, 10.2634F, 2.6616F, 0.0F, 0.0F));
		PartDefinition cube_r15 = body.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(25, 0).addBox(1.0F, -0.5432F, -0.6675F, 1.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = body.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(0, 17).addBox(-2.0F, -1.875F, -1.0F, 4.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0F, 8.0F, 0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r17 = body.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(23, 24).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = body.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(0, 26).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.25F, -5.8123F, -6.964F, 0.48F, -0.3491F, -0.1745F));
		PartDefinition cube_r19 = body.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(7, 24).addBox(0.0F, -1.175F, -0.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = body.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(19, 24).addBox(-1.0F, -1.175F, -0.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -3.8921F, -8.5834F, 0.3665F, -0.1309F, 0.3491F));
		PartDefinition cube_r21 = body.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(0, 31).addBox(-3.5F, -1.5F, -2.0F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -4.8488F, -6.2737F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r22 = body.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(36, 0).addBox(-5.0008F, -0.95F, -1.036F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = body.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(36, 4).addBox(0.0008F, -0.95F, -1.036F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.6386F, -4.275F, -7.0164F, -3.1416F, 1.2654F, 3.1416F));
		PartDefinition cube_r24 = body.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(18, 34).addBox(-5.9953F, -1.95F, -1.5349F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(0, 11).addBox(-5.9953F, 1.05F, -0.0349F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = body.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(34, 21).addBox(-0.0047F, -1.95F, -1.5349F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(0, 12).addBox(1.9953F, 1.05F, -0.0349F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.2069F, -4.275F, -11.5051F, -2.1484F, 0.9754F, -2.0427F));
		PartDefinition cube_r26 = body.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(0, 9).addBox(-6.0703F, -0.95F, -0.0349F, 5.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-6.0703F, 0.05F, -0.5349F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = body.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(0, 10).addBox(1.0703F, -0.95F, -0.0349F, 5.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(14, 40)
						.addBox(0.0703F, 0.05F, -0.5349F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.2069F, -4.275F, -11.5051F, 2.4638F, 1.1725F, 2.4118F));
		PartDefinition cube_r28 = body.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(34, 17).addBox(-8.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -4.25F, -4.5F, 0.0F, -0.48F, 0.0F));
		PartDefinition cube_r29 = body.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(34, 27).addBox(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -4.25F, -4.5F, 0.0F, 0.48F, 0.0F));
