...
public class BogShroomStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 600000) {
						...
						for (int a = 0; a < count; a++) {
							...
							if (blockAt.getBlock() == RomaMudBlock.block)
								blockCriteria = true;
							if (blockAt.getBlock() == RomaMud2Block.block)
								blockCriteria = true;
							if (!blockCriteria)
								continue;
			...
			event.getRegistry().register(feature.setRegistryName("bog_shroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("theabyss:bog_shroom"), configuredFeature);
		}
	}
