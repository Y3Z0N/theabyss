...
public class LayingTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static LayingTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LayingTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:laying_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:laying_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
