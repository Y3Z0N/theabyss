...
public class BogShroomFeature extends Feature<NoneFeatureConfiguration> {
	public static BogShroomFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BogShroomFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:bog_shroom", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:bog_shroom", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public BogShroomFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(TheabyssModBlocks.ROMA_MUD.get(), TheabyssModBlocks.ROMA_MUD_2.get());
	}
