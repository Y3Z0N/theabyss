...
public class SlimeForestBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final SlimeForestBiomeLeaveDecorator INSTANCE = new SlimeForestBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("slime_forest_tree_leave_decorator", tdt);
	}

	public SlimeForestBiomeLeaveDecorator() {
		super(0.25f);
	}
