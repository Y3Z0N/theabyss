...
public class LuroFeature extends Feature<NoneFeatureConfiguration> {
	public static LuroFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LuroFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:luro", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:luro", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
