...
public class ThunderFlowerFeature extends RandomPatchFeature {
	public static ThunderFlowerFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:thunder_flower", FEATURE, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
				new SimpleBlockConfiguration(BlockStateProvider.simple(TheabyssModBlocks.THUNDER_FLOWER.get().defaultBlockState())), List.of(), 64));
