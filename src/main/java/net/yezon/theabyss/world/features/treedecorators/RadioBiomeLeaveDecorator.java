...
public class RadioBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final RadioBiomeLeaveDecorator INSTANCE = new RadioBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("radio_biome_tree_leave_decorator");
