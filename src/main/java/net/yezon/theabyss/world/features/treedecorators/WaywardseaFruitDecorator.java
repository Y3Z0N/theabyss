...
public class WaywardseaFruitDecorator extends CocoaDecorator {
	public static final WaywardseaFruitDecorator INSTANCE = new WaywardseaFruitDecorator();
	public static com.mojang.serialization.Codec<WaywardseaFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("waywardsea_tree_fruit_decorator", tdt);
	}

	public WaywardseaFruitDecorator() {
		super(0.2f);
	}
