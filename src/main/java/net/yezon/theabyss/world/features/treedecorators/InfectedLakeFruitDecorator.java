...
public class InfectedLakeFruitDecorator extends CocoaDecorator {
	public static final InfectedLakeFruitDecorator INSTANCE = new InfectedLakeFruitDecorator();
	public static com.mojang.serialization.Codec<InfectedLakeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("infected_lake_tree_fruit_decorator", tdt);
	}

	public InfectedLakeFruitDecorator() {
		super(0.2f);
	}
