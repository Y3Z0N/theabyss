...
public class MudPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final MudPlainsLeaveDecorator INSTANCE = new MudPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("mud_plains_tree_leave_decorator", tdt);
	}

	public MudPlainsLeaveDecorator() {
		super(0.25f);
	}
