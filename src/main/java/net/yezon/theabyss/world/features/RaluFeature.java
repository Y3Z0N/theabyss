...
public class RaluFeature extends Feature<NoneFeatureConfiguration> {
	public static RaluFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new RaluFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:ralu", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:ralu", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
