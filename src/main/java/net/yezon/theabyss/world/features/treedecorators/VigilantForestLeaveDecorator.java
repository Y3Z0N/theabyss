...
public class VigilantForestLeaveDecorator extends LeaveVineDecorator {
	public static final VigilantForestLeaveDecorator INSTANCE = new VigilantForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("vigilant_forest_tree_leave_decorator", tdt);
	}

	public VigilantForestLeaveDecorator() {
		super(0.25f);
	}
