...
public class LaroFeature extends Feature<NoneFeatureConfiguration> {
	public static LaroFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LaroFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:laro", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:laro", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
