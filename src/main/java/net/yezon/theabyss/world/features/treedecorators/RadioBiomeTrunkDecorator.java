...
public class RadioBiomeTrunkDecorator extends TrunkVineDecorator {
	public static final RadioBiomeTrunkDecorator INSTANCE = new RadioBiomeTrunkDecorator();
	public static com.mojang.serialization.Codec<RadioBiomeTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("radio_biome_tree_trunk_decorator");
