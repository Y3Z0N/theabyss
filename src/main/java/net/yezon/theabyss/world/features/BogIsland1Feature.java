...
public class BogIsland1Feature extends Feature<NoneFeatureConfiguration> {
	public static BogIsland1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BogIsland1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:bog_island_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:bog_island_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
