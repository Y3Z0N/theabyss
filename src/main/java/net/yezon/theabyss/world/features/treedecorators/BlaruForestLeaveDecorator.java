...
public class BlaruForestLeaveDecorator extends LeaveVineDecorator {
	public static final BlaruForestLeaveDecorator INSTANCE = new BlaruForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("blaru_forest_tree_leave_decorator", tdt);
	}

	public BlaruForestLeaveDecorator() {
		super(0.25f);
	}
