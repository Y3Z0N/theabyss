...
public class InfectedGravelFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:gravel", FEATURE,
				new OreConfiguration(InfectedGravelFeatureRuleTest.INSTANCE, TheabyssModBlocks.GRAVEL.get().defaultBlockState(), 31));
	...
	private static class InfectedGravelFeatureRuleTest extends RuleTest {
		static final InfectedGravelFeatureRuleTest INSTANCE = new InfectedGravelFeatureRuleTest();
		private static final com.mojang.serialization.Codec<InfectedGravelFeatureRuleTest> CODEC = com.mojang.serialization.Codec
				.unit(() -> INSTANCE);
		private static final RuleTestType<InfectedGravelFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("theabyss:gravel_match"), CUSTOM_MATCH);
		}
