...
public class DreamBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final DreamBiomeLeaveDecorator INSTANCE = new DreamBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("dream_biome_tree_leave_decorator");
