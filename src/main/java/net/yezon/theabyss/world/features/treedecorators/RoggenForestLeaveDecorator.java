...
public class RoggenForestLeaveDecorator extends LeaveVineDecorator {
	public static final RoggenForestLeaveDecorator INSTANCE = new RoggenForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("roggen_forest_tree_leave_decorator", tdt);
	}

	public RoggenForestLeaveDecorator() {
		super(0.25f);
	}
