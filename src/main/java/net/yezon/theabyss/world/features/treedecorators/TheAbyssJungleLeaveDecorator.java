...
public class TheAbyssJungleLeaveDecorator extends LeaveVineDecorator {
	public static final TheAbyssJungleLeaveDecorator INSTANCE = new TheAbyssJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("blue_jungle_tree_leave_decorator", tdt);
	}

	public TheAbyssJungleLeaveDecorator() {
		super(0.25f);
	}
