...
public class VigilantLayingTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static VigilantLayingTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new VigilantLayingTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:vigilant_laying_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:vigilant_laying_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public VigilantLayingTreeFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(TheabyssModBlocks.VIGILANT_MOSS.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("theabyss", "vigilant_laying_tree"));
		if (template == null)
			return false;
