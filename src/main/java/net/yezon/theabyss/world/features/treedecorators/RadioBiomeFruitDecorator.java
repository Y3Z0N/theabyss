...
public class RadioBiomeFruitDecorator extends CocoaDecorator {
	public static final RadioBiomeFruitDecorator INSTANCE = new RadioBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<RadioBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("radio_biome_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public RadioBiomeFruitDecorator() {
		super(0.2f);
	}
