...
public class AybssMountainLeaveDecorator extends LeaveVineDecorator {
	public static final AybssMountainLeaveDecorator INSTANCE = new AybssMountainLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("blue_mountain_tree_leave_decorator", tdt);
	}

	public AybssMountainLeaveDecorator() {
		super(0.25f);
	}
