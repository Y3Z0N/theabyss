...
public class IncorytheOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:incorythe_ore", FEATURE,
				new OreConfiguration(IncorytheOreFeatureRuleTest.INSTANCE, TheabyssModBlocks.INCORYTHE_ORE.get().defaultBlockState(), 4));
	...
	private static class IncorytheOreFeatureRuleTest extends RuleTest {
		static final IncorytheOreFeatureRuleTest INSTANCE = new IncorytheOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<IncorytheOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<IncorytheOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("theabyss:incorythe_ore_match"), CUSTOM_MATCH);
		}
