...
public class IcoraFlowerFeature extends RandomPatchFeature {
	public static IcoraFlowerFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:icora_flower", FEATURE, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
				new SimpleBlockConfiguration(BlockStateProvider.simple(TheabyssModBlocks.ICORA_FLOWER.get().defaultBlockState())), List.of(), 64));
