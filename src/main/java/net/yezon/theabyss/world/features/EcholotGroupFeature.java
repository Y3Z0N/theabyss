...
public class EcholotGroupFeature extends Feature<NoneFeatureConfiguration> {
	public static EcholotGroupFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new EcholotGroupFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:echolot_group", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:echolot_group", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("theabyss:blue_jungle"),
			new ResourceLocation("theabyss:fungal_forest"));
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("theabyss", "echolot_group_big"));
		if (template == null)
			return false;
