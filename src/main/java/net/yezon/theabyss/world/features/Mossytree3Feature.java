...
public class Mossytree3Feature extends Feature<NoneFeatureConfiguration> {
	public static Mossytree3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Mossytree3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:mossytree_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:mossytree_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
