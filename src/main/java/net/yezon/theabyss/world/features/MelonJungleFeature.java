...
public class MelonJungleFeature extends Feature<NoneFeatureConfiguration> {
	public static MelonJungleFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MelonJungleFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:melon_jungle", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("theabyss:melon_jungle", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
