...
public class SralaShroomFeature extends RandomPatchFeature {
	public static SralaShroomFeature FEATURE = null;
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("theabyss:srala_shroom", FEATURE, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
				new SimpleBlockConfiguration(BlockStateProvider.simple(TheabyssModBlocks.SRALA_SHROOM.get().defaultBlockState())), List.of(), 64));
