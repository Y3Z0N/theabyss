...
public class RoggenForestBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("theabyss:disk_gravel_roggen_forest",
						FeatureUtils.register("theabyss:disk_gravel_roggen_forest", Feature.DISK,
								new DiskConfiguration(Blocks.GRAVEL.defaultBlockState(), UniformInt.of(2, 5), 2,
										List.of(TheabyssModBlocks.TANTRA_GRASS.get().defaultBlockState(),
												TheabyssModBlocks.TANTRA_DIRT.get().defaultBlockState()))),
