...
public class WaywardseaBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-4131073).waterColor(-13421721).waterFogColor(-4737097)
				.skyColor(-4131073).foliageColorOverride(-5573377).grassColorOverride(-1245697)
				...
				PlacementUtils.register("theabyss:tree_waywardsea",
						FeatureUtils.register("theabyss:tree_waywardsea", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.DARK_OAK_LOG.defaultBlockState()),
										new ForkingTrunkPlacer(25, 2, 2), BlockStateProvider.simple(Blocks.OAK_LEAVES.defaultBlockState()),
										new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2))
										.decorators(ImmutableList.of(WaywardseaLeaveDecorator.INSTANCE, WaywardseaTrunkDecorator.INSTANCE,
												WaywardseaFruitDecorator.INSTANCE))
										.build()),
						List.of(CountPlacement.of(11), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING),
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("theabyss:grass_waywardsea", VegetationFeatures.PATCH_GRASS,
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.SNOW).biomeCategory(Biome.BiomeCategory.NONE).temperature(-1f).downfall(1f)
