...
public class MudPlainsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-16376551).waterColor(-16301778).waterFogColor(-15588065)
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).temperature(0.6f).downfall(0.5f).specialEffects(effects)
