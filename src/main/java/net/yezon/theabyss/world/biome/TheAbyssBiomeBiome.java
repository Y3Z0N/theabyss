...
public class TheAbyssBiomeBiome extends TheAbyss.Processor {
	public static Biome biome;

	public TheAbyssBiomeBiome(TheAbyss instance) {
		super(instance, 531);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16699858).setWaterColor(-16764109).setWaterFogColor(-16764109)
						.withSkyColor(-16699858).withFoliageColor(-16764109).withGrassColor(-16701914)
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("theabyss:blue_forest_ambience")))
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BlaruMossBlock.block.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.GRAVEL.getDefaultState(), FeatureSpread.func_242253_a(2, 3), 2,
										ImmutableList.of(BlaruMossBlock.block.getDefaultState(), DirtBlock.block.getDefaultState())))
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.5599999999999999f).scale(0.25f)
						.temperature(0.5f).downfall(0.3f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("theabyss:blue_forest"));
			}
		}
	}
