...
public class ExtractorMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ExtractorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheabyssModMenus.EXTRACTOR.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ExtractorMenu) {
