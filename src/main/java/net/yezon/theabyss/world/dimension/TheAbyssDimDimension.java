...
public class TheAbyssDimDimension extends TheAbyss.Processor {
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("the_abyss_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("the_abyss_portal");
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote
				...
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("theabyss:the_abyss"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("theabyss:the_abyss")));
				} else {
					entity.func_242279_ag();
