...
public class PocketDimensionDimension extends TheAbyss.Processor {
	public PocketDimensionDimension(TheAbyss instance) {
		super(instance, 461);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("theabyss:pocket_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
