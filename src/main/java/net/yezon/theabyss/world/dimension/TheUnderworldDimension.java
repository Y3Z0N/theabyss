...
public class TheUnderworldDimension extends TheAbyss.Processor {
	public TheUnderworldDimension(TheAbyss instance) {
		super(instance, 524);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("theabyss:the_underworld"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
