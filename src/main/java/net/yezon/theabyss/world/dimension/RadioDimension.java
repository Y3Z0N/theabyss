...
public class RadioDimension extends TheAbyss.Processor {
	public RadioDimension(TheAbyss instance) {
		super(instance, 1135);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("theabyss:radio"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
