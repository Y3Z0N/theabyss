...
public class FriendleyFireAKeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FriendleyFireAKeyBinding(TheAbyss instance) {
		super(instance, 1307);
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.friendley_fire_a", GLFW.GLFW_KEY_RIGHT, "key.categories.misc");
