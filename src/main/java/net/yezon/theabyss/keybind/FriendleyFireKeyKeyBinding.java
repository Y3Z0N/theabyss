...
public class FriendleyFireKeyKeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FriendleyFireKeyKeyBinding(TheAbyss instance) {
		super(instance, 1309);
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.friendley_fire_key", GLFW.GLFW_KEY_RIGHT, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Friendly1Event.executeEvent(Stream
