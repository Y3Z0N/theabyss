...
public class FriendleyFireKey2KeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FriendleyFireKey2KeyBinding(TheAbyss instance) {
		super(instance, 1310);
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.friendley_fire_key_2", GLFW.GLFW_KEY_LEFT, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Friendly2Event.executeEvent(Stream
