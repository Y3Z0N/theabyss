...
public class FriendleyFireBKeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FriendleyFireBKeyBinding(TheAbyss instance) {
		super(instance, 1308);
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.friendley_fire_b", GLFW.GLFW_KEY_LEFT, "key.categories.misc");
