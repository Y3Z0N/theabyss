...
public class GhostFireAttackKeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;

	public GhostFireAttackKeyBinding(TheAbyss instance) {
		super(instance, 1023);
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.ghost_fire_attack", GLFW.GLFW_KEY_C, "key.categories.abyss");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			ApplyGhostFireAttackEvent.executeEvent(Stream
