...
public class GhostAttackKeyBinding extends TheAbyss.Processor {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.theabyss.ghost_attack", GLFW.GLFW_KEY_X, "key.categories.abyss");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			ApplyGhostAttackEvent.executeEvent(Stream
