...
public class FrostCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frost_crystal")
	public static final Item block = null;

	public FrostCrystalItem(TheAbyss instance) {
		super(instance, 60);
	}
