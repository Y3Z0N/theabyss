...
import net.yezon.theabyss.eventhandlers.ApplyRingOfPocketRoomEventHandler;
...
public class RingOfPocketBoxItem extends Item {
	public RingOfPocketBoxItem() {
...
public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
  ...
  list.add(Component.literal("\uEF02 50.0 \uEF04 100.0 \uEF03 Right Click"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfPocketRoomEventHandler.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
