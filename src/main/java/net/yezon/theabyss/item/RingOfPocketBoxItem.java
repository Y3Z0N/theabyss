...
import net.yezon.theabyss.events.ApplyRingOfPocketRoomEvent;
...
public class RingOfPocketBoxItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_pocket_box")
	public static final Item block = null;
	public RingOfPocketBoxItem(TheAbyss instance) {
		super(instance, 147);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ring_of_pocket_box");
		}
...
list.add(new StringTextComponent("\u00A7bAbility\u00A7f: Your own Pocket-Dimension room."));
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				ApplyRingOfPocketRoomEvent.executeEvent($_dependencies);
			}
			return ar;
		}
	}
