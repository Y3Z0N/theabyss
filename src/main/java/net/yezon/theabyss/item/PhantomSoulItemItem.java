...
public class PhantomSoulItemItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:phantom_soul_item")
	public static final Item block = null;

	public PhantomSoulItemItem(TheAbyss instance) {
		super(instance, 122);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("phantom_soul_item");
		}
