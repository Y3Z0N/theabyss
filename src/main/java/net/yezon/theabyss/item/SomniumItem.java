...
public class SomniumItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:somnium")
	...
	public static class ItemCustom extends Item {
		...
		public void onCreated(ItemStack itemstack, World world, PlayerEntity entity) {
			...
			GetSomniumAdvEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
