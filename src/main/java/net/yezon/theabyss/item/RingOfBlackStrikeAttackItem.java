...
import net.yezon.theabyss.entity.renderer.RingOfBlackStrikeAttackRenderer;
...
public class RingOfBlackStrikeAttackItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_black_strike_attack")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ring_of_black_strike_attack");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			RingOfBlackStrikeAttackBulletHitsLivingEntityEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
		...
		public void tick() {
			...
			RingOfBlackStrikeParticleEvent.executeEvent(Stream
