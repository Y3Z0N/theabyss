...
public class HollowCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:hollow_crystal")
	public static final Item block = null;

	public HollowCrystalItem(TheAbyss instance) {
		super(instance, 66);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hollow_crystal");
		}
