...
import net.yezon.theabyss.events.WandHandlerEvent;
import net.yezon.theabyss.gui.WandGuiGuiWindow;
import net.yezon.theabyss.gui.WandGuiGui;
...
public class WandItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:wand")
	public static final Item block = null;

	public WandItem(TheAbyss instance) {
		super(instance, 885);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof WandGuiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("this is a test item don't use it"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Wand (InDev Item)");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new WandGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
			...
			WandHandlerEvent.executeEvent(Stream
