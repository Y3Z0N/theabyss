...
public class HollowPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:hollow_powder")
	public static final Item block = null;

	public HollowPowderItem(TheAbyss instance) {
		super(instance, 64);
	}
