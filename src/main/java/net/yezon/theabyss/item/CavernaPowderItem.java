...
public class CavernaPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:caverna_powder")
	public static final Item block = null;

	public CavernaPowderItem(TheAbyss instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("caverna_powder");
		}
