...
public class GlacerytheGemItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:glacerythe_gem")
	public static final Item block = null;

	public GlacerytheGemItem(TheAbyss instance) {
		super(instance, 102);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("glacerythe_gem");
		}
