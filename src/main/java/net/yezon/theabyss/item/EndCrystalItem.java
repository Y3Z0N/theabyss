...
public class EndCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:end_crystal")
	public static final Item block = null;

	public EndCrystalItem(TheAbyss instance) {
		super(instance, 56);
	}
