...
public class IgnisitheGemItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ignisithe_gem")
	public static final Item block = null;

	public IgnisitheGemItem(TheAbyss instance) {
		super(instance, 98);
	}
