...
import net.yezon.theabyss.events.ApplyRingOfFangsEvent;
...
list.add(new TextComponent("\u00A7bAbility\u00A7f: Summon fangs around you and to any entity near you."));
...
list.add(new TextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfFangsEvent.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		ApplyRingOfFangsEvent.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
