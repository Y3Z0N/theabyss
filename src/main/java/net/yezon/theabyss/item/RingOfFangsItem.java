...
public class RingOfFangsItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_fangs")
	public static final Item block = null;
	public RingOfFangsItem(TheAbyss instance) {
		super(instance, 152);
	}
...
list.add(new StringTextComponent("\u00A7bAbility\u00A7f: Summon fangs around you and to any entity near you."));
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				ApplyRingOfFangsEvent.executeEvent($_dependencies);
			}
			return ar;
		}
