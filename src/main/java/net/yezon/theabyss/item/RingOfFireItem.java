...
import net.yezon.theabyss.eventhandlers.ApplyRingOfFireEventHandler;
...
public class RingOfFireItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("tooltip.theabyss.ring_of_fire"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfFireEventHandler.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		ApplyRingOfFireEventHandler.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
