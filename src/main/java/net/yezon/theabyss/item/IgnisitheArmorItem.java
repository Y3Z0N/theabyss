...
public class IgnisitheArmorItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ignisithe_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("theabyss:ignisithe_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("theabyss:ignisithe_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("theabyss:ignisithe_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TheAbyssArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "theabyss:textures/models/armor/ignisithe__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("ignisithe_armor_helmet"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(TheAbyssArmorItemGroup.tab)) {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("[+] \u00A7bFire Resistance Buff"));
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				IgnisitheArmorBodyAbilityEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("ignisithe_armor_chestplate"));
		...
		}.setRegistryName("ignisithe_armor_leggings"));
		...
		}.setRegistryName("ignisithe_armor_boots"));
	}
