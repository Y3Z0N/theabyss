...
public class FusionArmorItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:fusion_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("theabyss:fusion_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("theabyss:fusion_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("theabyss:fusion_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TheAbyssArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "theabyss:textures/models/armor/fusion__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("fusion_armor_helmet"));
		...
		}.setRegistryName("fusion_armor_chestplate"));
		...
		}.setRegistryName("fusion_armor_leggings"));
		...
		}.setRegistryName("fusion_armor_boots"));
	}
