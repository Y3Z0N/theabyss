...
public class WarpedCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:warped_crystal")
	public static final Item block = null;

	public WarpedCrystalItem(TheAbyss instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("warped_crystal");
		}
