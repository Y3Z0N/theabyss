...
public class CrimsonPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:crimson_powder")
	public static final Item block = null;

	public CrimsonPowderItem(TheAbyss instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crimson_powder");
		}
