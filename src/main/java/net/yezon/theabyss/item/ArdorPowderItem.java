...
public class ArdorPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ardor_powder")
	public static final Item block = null;

	public ArdorPowderItem(TheAbyss instance) {
		super(instance, 61);
	}
