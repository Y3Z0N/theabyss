...
public class HollowCrystalShardItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:hollow_crystal_shard")
	public static final Item block = null;

	public HollowCrystalShardItem(TheAbyss instance) {
		super(instance, 67);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hollow_crystal_shard");
		}
