...
public class SomniumRegenUpgradeItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:somnium_regen_upgrade")
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(TheAbyssItemGroup.tab).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.2f).setAlwaysEdible()
							...
							.build()));
			setRegistryName("somnium_regen_upgrade");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			ManaRegenUpgradeResultEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
