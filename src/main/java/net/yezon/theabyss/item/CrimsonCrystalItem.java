...
public class CrimsonCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:crimson_crystal")
	public static final Item block = null;

	public CrimsonCrystalItem(TheAbyss instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crimson_crystal");
		}
