...
import net.yezon.theabyss.eventhandlers.ApplyRingOfHomeEventHandler;
...
list.add(Component.literal("\uEF02 50.0 \uEF04 100.0 \uEF03 Right Click"));
		list.add(Component.translatable("tooltip.theabyss.ring_of_home"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfHomeEventHandler.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		ApplyRingOfHomeEventHandler.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
