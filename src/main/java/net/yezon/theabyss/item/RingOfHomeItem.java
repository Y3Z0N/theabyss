...
public class RingOfHomeItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_home")
	public static final Item block = null;

	public RingOfHomeItem(TheAbyss instance) {
		super(instance, 146);
	}
...
list.add(new StringTextComponent("\u00A7bAbility\u00A7f: Brings you back to your bed but you need to sleep in it before."));
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ApplyRingOfHomeEvent.executeEvent(Stream
