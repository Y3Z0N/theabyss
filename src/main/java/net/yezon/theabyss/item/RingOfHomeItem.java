...
import net.yezon.theabyss.events.ApplyRingOfHomeEvent;
...
public class RingOfHomeItem extends Item {
	public RingOfHomeItem() {
...
list.add(new TextComponent("\u00A7bAbility\u00A7f: Brings you back to your bed but you need to sleep in it before."));
...
list.add(new TextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfHomeEvent.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		ApplyRingOfHomeEvent.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
