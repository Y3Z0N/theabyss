...
public class CavernaCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:caverna_crystal")
	public static final Item block = null;

	public CavernaCrystalItem(TheAbyss instance) {
		super(instance, 73);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("caverna_crystal");
		}
