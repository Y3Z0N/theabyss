...
public class AberytheGemItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aberythe_gem")
	public static final Item block = null;

	public AberytheGemItem(TheAbyss instance) {
		super(instance, 92);
	}
