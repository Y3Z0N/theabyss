...
public class AbyssCrystalItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:abyss_crystal")
	public static final Item block = null;

	public AbyssCrystalItem(TheAbyss instance) {
		super(instance, 64);
	}
