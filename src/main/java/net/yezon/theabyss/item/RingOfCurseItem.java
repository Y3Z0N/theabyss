...
import net.yezon.theabyss.eventhandlers.ApplyRingOfCurseEventHandler;
...
public class RingOfCurseItem extends Item {
	public RingOfCurseItem() {
...
public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
  ...
  list.add(Component.literal("\uEF02 50.0 \uEF04 100.0 \uEF03 Right Click"));
		list.add(Component.translatable("tooltip.theabyss.ring_of_curse"));
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ApplyRingOfCurseEventHandler.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		ApplyRingOfCurseEventHandler.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
