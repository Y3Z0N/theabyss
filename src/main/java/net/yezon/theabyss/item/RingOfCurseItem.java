...
public class RingOfCurseItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_curse")
	public static final Item block = null;
	public RingOfCurseItem(TheAbyss instance) {
		super(instance, 143);
	}
...
list.add(new StringTextComponent("\u00A7bAbility\u00A7f: Makes all near opponents weak."));
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				ApplyRingOfCurseEvent.executeEvent($_dependencies);
			}
			return ar;
		}
