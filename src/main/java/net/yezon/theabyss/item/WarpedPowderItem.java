...
public class WarpedPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:warped_powder")
	public static final Item block = null;

	public WarpedPowderItem(TheAbyss instance) {
		super(instance, 66);
	}
