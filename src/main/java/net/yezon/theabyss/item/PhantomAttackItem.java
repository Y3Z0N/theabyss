...
public class PhantomAttackItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:phantom_attack")
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:phantom_attack")),
