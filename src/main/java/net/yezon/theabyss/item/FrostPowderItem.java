...
public class FrostPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:frost_powder")
	public static final Item block = null;

	public FrostPowderItem(TheAbyss instance) {
		super(instance, 63);
	}
