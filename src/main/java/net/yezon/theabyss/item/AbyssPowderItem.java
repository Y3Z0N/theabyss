...
public class AbyssPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:abyss_powder")
	public static final Item block = null;

	public AbyssPowderItem(TheAbyss instance) {
		super(instance, 55);
	}
