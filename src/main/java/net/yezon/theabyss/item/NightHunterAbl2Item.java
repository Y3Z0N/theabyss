...
import net.yezon.theabyss.entity.renderer.NightHunterAbl2Renderer;
...
public class NightHunterAbl2Item extends TheAbyss.Processor {
	@ObjectHolder("theabyss:night_hunter_abl_2")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(null).maxDamage(280));
			setRegistryName("night_hunter_abl_2");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 1, 1);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			TeleportHandlerEvent.executeEvent(Stream
