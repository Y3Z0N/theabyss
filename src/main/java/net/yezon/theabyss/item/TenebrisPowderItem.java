...
public class TenebrisPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:tenebris_powder")
	public static final Item block = null;

	public TenebrisPowderItem(TheAbyss instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tenebris_powder");
		}
