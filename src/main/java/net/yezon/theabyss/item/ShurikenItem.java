...
import net.yezon.theabyss.entity.renderer.ShurikenRenderer;
...
public class ShurikenItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:shuriken")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(TheAbyssWeaponsItemGroup.tab).maxDamage(32));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("can be used 32 times"));
		}
