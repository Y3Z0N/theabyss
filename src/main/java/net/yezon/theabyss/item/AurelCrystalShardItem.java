...
public class AurelCrystalShardItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aurel_crystal_shard")
	public static final Item block = null;

	public AurelCrystalShardItem(TheAbyss instance) {
		super(instance, 74);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aurel_crystal_shard");
		}
