...
public abstract class FusionedAberytheArmorItem extends ArmorItem {
	public FusionedAberytheArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.NETHERITE_INGOT), new ItemStack(TheabyssModItems.ABERYTHE_GEM.get()));
			}
	...
	public static class Helmet extends FusionedAberytheArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends FusionedAberytheArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FusionedAberytheArmorItem {
		public Leggings() {
	...
	public static class Boots extends FusionedAberytheArmorItem {
		public Boots() {
