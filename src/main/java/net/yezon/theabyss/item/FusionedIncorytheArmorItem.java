...
public abstract class FusionedIncorytheArmorItem extends ArmorItem {
	public FusionedIncorytheArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends FusionedIncorytheArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends FusionedIncorytheArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends FusionedIncorytheArmorItem {
		public Leggings() {
	...
	public static class Boots extends FusionedIncorytheArmorItem {
		public Boots() {
