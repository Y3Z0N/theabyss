...
public class BoneArmorItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:bone_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("theabyss:bone_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("theabyss:bone_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("theabyss:bone_armor_boots")
	public static final Item boots = null;

	public BoneArmorItem(TheAbyss instance) {
		super(instance, 543);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TheAbyssArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "theabyss:textures/models/armor/bone__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
