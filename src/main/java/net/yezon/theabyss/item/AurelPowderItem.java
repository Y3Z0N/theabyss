...
public class AurelPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aurel_powder")
	public static final Item block = null;

	public AurelPowderItem(TheAbyss instance) {
		super(instance, 56);
	}
