...
public class FearPowderItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:fear_powder")
	public static final Item block = null;

	public FearPowderItem(TheAbyss instance) {
		super(instance, 60);
	}
