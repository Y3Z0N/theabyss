...
public class PhantomWandItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:phantom_wand")
	public static final Item block = null;
	@ObjectHolder("theabyss:entitybulletphantom_wand")
	public static final EntityType arrow = null;
	public PhantomWandItem(TheAbyss instance) {
		super(instance, 778);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletphantom_wand").setRegistryName("entitybulletphantom_wand"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
			...
			World world = entity.world;
			{
				...
				PhantomAttackRangedItemUsedEvent.executeEvent($_dependencies);
			}
			return retval;
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				PhantomAttackBulletHitsPlayerEvent.executeEvent($_dependencies);
			}
		}
		...
		public void tick() {
			...
			Entity entity = this.func_234616_v_();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PhantomAttackWhileBulletFlyingTickEvent.executeEvent($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
