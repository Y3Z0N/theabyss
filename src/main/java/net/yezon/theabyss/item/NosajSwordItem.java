...
public class NosajSwordItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:nosaj_sword")
	public static final Item block = null;

	public NosajSwordItem(TheAbyss instance) {
		super(instance, 11);
	}
