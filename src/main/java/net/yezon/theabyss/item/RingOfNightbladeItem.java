...
public class RingOfNightbladeItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_nightblade")
	public static final Item block = null;
	public RingOfNightbladeItem(TheAbyss instance) {
		super(instance, 145);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ring_of_nightblade");
		}
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				ApplyRingOfNightbladeEvent.executeEvent($_dependencies);
			}
			return ar;
		}
