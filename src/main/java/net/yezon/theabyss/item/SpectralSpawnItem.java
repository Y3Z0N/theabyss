...
import net.yezon.theabyss.entity.renderer.SpectralSpawnRenderer;
...
public class SpectralSpawnItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:spectral_spawn")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(null).maxDamage(30));
			setRegistryName("spectral_spawn");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.2f, 0, 0);
