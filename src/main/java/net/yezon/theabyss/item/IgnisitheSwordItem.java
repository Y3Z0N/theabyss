...
import net.yezon.theabyss.eventhandlers.IgnisitheSwordAbilityEventHandler;
...
public class IgnisitheSwordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		IgnisitheSwordAbilityEventHandler.execute(entity.level, entity.getX(), entity.getY(), entity.getZ(), entity);
		return retval;
	}
}
