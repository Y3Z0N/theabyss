...
public class RingOfSpectralItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_spectral")
	public static final Item block = null;
	public RingOfSpectralItem(TheAbyss instance) {
		super(instance, 134);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ring_of_spectral");
		}
...
list.add(new StringTextComponent("\u00A7bAbility\u00A7f: You\u2019ll have a out of body experience."));
...
list.add(new StringTextComponent("This item must be produced in the \u00A7bArcane Workbench.\u00A7f"));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				ApplyRingOfSpectralEvent.executeEvent($_dependencies);
			}
			return ar;
		}
