...
import net.yezon.theabyss.entity.renderer.RingOfFireStrikeAttackRenderer;
...
public class RingOfFireStrikeAttackItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:ring_of_fire_strike_attack")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ring_of_fire_strike_attack");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			RingOfFireStrikeAttackProjectileHitsBlockEvent.executeEvent(Stream
		...
		public void tick() {
			...
			RingOfFireStrikeParticleEvent.executeEvent(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			if (this.inGround) {
