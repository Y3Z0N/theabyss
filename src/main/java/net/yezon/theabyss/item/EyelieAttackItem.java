...
import net.yezon.theabyss.entity.renderer.EyelieAttackRenderer;
...
public class EyelieAttackItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:eyelie_attack")
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("this is the attack what an angry eyelie does."));
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.5f, 1, 1);
