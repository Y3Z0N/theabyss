...
public class ShurikenExplosiveItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:shuriken_explosive")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(TheAbyssWeaponsItemGroup.tab).maxDamage(8));
			setRegistryName("shuriken_explosive");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("can be used 8 times"));
		}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Ranged item modifier", (double) 2.2, AttributeModifier.Operation.ADDITION));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ShurikenExplosiveItem.block);
		}
