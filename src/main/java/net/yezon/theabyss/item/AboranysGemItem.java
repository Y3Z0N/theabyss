...
public class AboranysGemItem extends TheAbyss.Processor {
	@ObjectHolder("theabyss:aboranys_gem")
	public static final Item block = null;

	public AboranysGemItem(TheAbyss instance) {
		super(instance, 96);
	}
