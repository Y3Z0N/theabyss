...
public class StrippLogHandlerEvent {
	...
	public static void executeEvent(Map<String, Object> dependencies) {
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() instanceof AxeItem
				&& BlaruLogBlock.block == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()) {
			{
			...
			}
			{
				...
				BlockState _bs = StrippedBlaruLogBlock.block.getDefaultState();
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() instanceof AxeItem
				&& JungleLogBlock.block == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()) {
			{
				ItemStack _ist = ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY);
				if (_ist.attemptDamageItem((int) 1, new Random(), null)) {
					_ist.shrink(1);
			...
			{
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				BlockState _bs = StippedJungleLogBlock.block.getDefaultState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateContainer().getProperty(entry.getKey().getName());
					if (_property != null && _bs.get(_property) != null)
