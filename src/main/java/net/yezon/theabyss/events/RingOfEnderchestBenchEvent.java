...
public class RingOfEnderchestBenchEvent {

	public static void executeEvent(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TheabyssMod.LOGGER.warn("Failed to load dependency entity for Event RingOfEnderchestBench!");
			return;
		}
		...
		if ((new Object() {
			...
			}.getItemStack((int) (2))).getItem() == CavernaCrystalItem.block && (new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
			...
			}.getItemStack((int) (4))).getItem() == CavernaCrystalItem.block && (new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
			...
			}.getItemStack((int) (6))).getItem() == CavernaCrystalItem.block && (new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
			...
			}.getItemStack((int) (8))).getItem() == CavernaCrystalItem.block) {
				{
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
