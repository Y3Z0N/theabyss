...
public class ArcaneButtonMessage {
	...
	public ArcaneButtonMessage(FriendlyByteBuf buffer) {
	...
	public ArcaneButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ArcaneButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ArcaneButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
