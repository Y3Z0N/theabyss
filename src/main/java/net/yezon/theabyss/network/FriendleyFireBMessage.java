...
import net.yezon.theabyss.eventhandlers.Friendly2EventHandler;
...
public class FriendleyFireBMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Friendly2EventHandler.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheabyssMod.addNetworkMessage(FriendleyFireBMessage.class, FriendleyFireBMessage::buffer, FriendleyFireBMessage::new, FriendleyFireBMessage::handler);
	}
}
