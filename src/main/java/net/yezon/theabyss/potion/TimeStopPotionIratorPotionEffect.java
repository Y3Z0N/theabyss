...
public class TimeStopPotionIratorPotionEffect {
	@ObjectHolder("theabyss:time_stop_potion_irator")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("time_stop_potion_irator");
		}

		@Override
		public String getName() {
			return "effect.time_stop_potion_irator";
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			TimeStopPotionIratorOnPotionActiveTickEvent.executeEvent(Stream
