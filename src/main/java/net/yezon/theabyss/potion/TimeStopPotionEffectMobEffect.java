...
import net.yezon.theabyss.eventhandlers.TimeStopParticlesEventHandler;
...
public class TimeStopPotionEffectMobEffect extends MobEffect {
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		TimeStopParticlesEventHandler.execute(entity.level, entity.getX(), entity.getY(), entity.getZ());
	}
