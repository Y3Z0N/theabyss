...
public class AfterLifePotionEffect {
	@ObjectHolder("theabyss:after_life")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			super(EffectType.NEUTRAL, -10092442);
			setRegistryName("after_life");
		}

		@Override
		public String getName() {
			return "effect.after_life";
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			AfterLifePotionStartEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void performEffect(LivingEntity entity, int amplifier) {
			...
			ReturnToBodyEvent.executeEvent(Stream
