...
import net.yezon.theabyss.entity.renderer.DeerRenderer;
...
public class DeerEntity extends TheAbyss.Processor {
	...
	public DeerEntity(TheAbyss instance) {
		super(instance, 404);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10158107, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("deer_spawn_egg"));
	}
