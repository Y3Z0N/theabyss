...
public class VersaWhaleEntity extends Monster {
	...
	public VersaWhaleEntity(EntityType<VersaWhaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:versa_whale_idle"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TheabyssModEntities.VERSA_WHALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
