...
import net.yezon.theabyss.entity.renderer.BrainWalkerRenderer;
...
public class BrainWalkerEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092442, -3407668, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("brain_walker_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 29);
