...
import net.yezon.theabyss.eventhandlers.SetMiniBossEventHandler;
...
public class CrystalGolemEntity extends Monster {
	...
	public CrystalGolemEntity(EntityType<CrystalGolemEntity> type, Level world) {
		...
		xpReward = 50;
		setNoAi(false);
		setCustomName(Component.literal("Crystal Golem"));
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		SetMiniBossEventHandler.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
