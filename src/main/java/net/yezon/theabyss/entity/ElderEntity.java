...
public class ElderEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16711732, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("elder_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 30;
			setNoAI(false);
			setCustomName(new StringTextComponent("Elder"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ElderEyeItem.block));
		}
