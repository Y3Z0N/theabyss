...
import net.yezon.theabyss.entity.renderer.FrostSpiderRenderer;
...
public class FrostSpiderEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4f, 1.2000000000000002f)).build("frost_spider").setRegistryName("frost_spider");

	public FrostSpiderEntity(TheAbyss instance) {
		super(instance, 427);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FrostSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6684673, -13057, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("frost_spider_spawn_egg"));
	}
