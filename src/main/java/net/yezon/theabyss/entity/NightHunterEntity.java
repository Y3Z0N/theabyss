...
import net.yezon.theabyss.entity.renderer.NightHunterRenderer;
...
public class NightHunterEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.8f, 1.8f)).build("night_hunter").setRegistryName("night_hunter");

	public NightHunterEntity(TheAbyss instance) {
		super(instance, 421);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightHunterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("night_hunter_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			NightHunterAbl2Item.shoot(this, target);
		}
