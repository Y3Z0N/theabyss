...
public class LizardEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16711783, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("lizard_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 80, 3, 5));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(LoranItem.block), false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:lizard_idle"));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (LoranItem.block == stack.getItem())
				return true;
			return false;
		}
	}
