...
import net.yezon.theabyss.entity.renderer.LuroFishRenderer;
...
public class LuroFishEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15059388, -16711732, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("luro_fish_spawn_egg"));
	}
