...
import net.yezon.theabyss.entity.renderer.LokusRenderer;
...
public class LokusEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.8f, 2.5f)).build("lokus").setRegistryName("lokus");

	public LokusEntity(TheAbyss instance) {
		super(instance, 426);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LokusRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10158107, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("lokus_spawn_egg"));
	}
