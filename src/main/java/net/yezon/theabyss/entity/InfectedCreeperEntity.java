...
public class InfectedCreeperEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750055, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("infected_creeper_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 28, 1, 3));
	}
	...
	public static class CustomEntity extends CreeperEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CreeperDustItem.block));
		}
