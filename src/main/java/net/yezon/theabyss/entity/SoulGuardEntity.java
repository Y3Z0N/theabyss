...
import net.yezon.theabyss.entity.renderer.SoulGuardRenderer;
...
public class SoulGuardEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(18).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("soul_guard_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 3, 2, 5));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 35;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(BoneSwordItemItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(BoneArmorItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(BoneArmorItem.body));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(BoneArmorItem.legs));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(BoneArmorItem.boots));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SoulHeartItem.block));
		}
