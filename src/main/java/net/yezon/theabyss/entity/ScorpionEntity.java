...
import net.yezon.theabyss.entity.renderer.ScorpionRenderer;
...
public class ScorpionEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4f, 1f)).build("scorpion").setRegistryName("scorpion");

	public ScorpionEntity(TheAbyss instance) {
		super(instance, 414);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764109, -10092289, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 4, 2, 3));
	}
	...
	public static class CustomEntity extends SpiderEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ScorpionEyeItem.block));
		}
