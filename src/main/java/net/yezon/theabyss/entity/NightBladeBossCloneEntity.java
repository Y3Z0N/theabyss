...
import net.yezon.theabyss.entity.renderer.NightBladeBossCloneRenderer;
...
public class NightBladeBossCloneEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.8f, 1.7999999999999998f)).build("night_blade_boss_clone").setRegistryName("night_blade_boss_clone");

	public NightBladeBossCloneEntity(TheAbyss instance) {
		super(instance, 385);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightBladeBossCloneRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("night_blade_boss_clone_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, AbyssalLionEntity.CustomEntity.class, false, false));
		}
