...
public class AbyssaurEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(TheabyssModEntities.ABYSSAUR.get(), 1, 1, 1));
	}
	...
	public AbyssaurEntity(EntityType<AbyssaurEntity> type, Level world) {
		super(type, world);
		xpReward = 20;
		setNoAi(false);
		setCustomName(new TextComponent("Abyssaur"));
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:abyssaur_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:abyssaur_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("theabyss:abyssaur_death"));
	}
