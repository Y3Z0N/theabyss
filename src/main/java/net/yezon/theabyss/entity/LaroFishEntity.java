...
import net.yezon.theabyss.entity.renderer.LaroFishRenderer;
...
public class LaroFishEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14539719, -16711732, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("laro_fish_spawn_egg"));
	}
