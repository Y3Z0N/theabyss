...
import net.yezon.theabyss.entity.renderer.SeekerRenderer;
...
public class SeekerEntity extends TheAbyss.Processor {
	public static EntityType entity = null;
	public SeekerEntity(TheAbyss instance) {
		super(instance, 456);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeekerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.7999999999999999f, 2f))
						.build("seeker").setRegistryName("seeker");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("seeker_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SeekerOnEntityTickUpdateEvent.executeEvent($_dependencies);
			}
		}
	}
}
