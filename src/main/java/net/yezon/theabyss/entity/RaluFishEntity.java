...
import net.yezon.theabyss.entity.renderer.RaluFishRenderer;
...
public class RaluFishEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15387549, -16711732, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("ralu_fish_spawn_egg"));
	}
