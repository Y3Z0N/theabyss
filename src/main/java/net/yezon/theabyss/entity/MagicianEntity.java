...
import net.yezon.theabyss.entity.renderer.MagicianRenderer;
...
public class MagicianEntity extends TheAbyss.Processor {
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return MagicianSpawnEvent.executeEvent(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Magician"));
		...
		public void baseTick() {
			...
			MagicianAbilitiesEvent.executeEvent(Stream
