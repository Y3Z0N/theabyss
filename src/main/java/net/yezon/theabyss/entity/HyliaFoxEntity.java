...
import net.yezon.theabyss.entity.renderer.HyliaFoxRenderer;
...
public class HyliaFoxEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.8f, 0.8f)).build("hylia_fox").setRegistryName("hylia_fox");

	public HyliaFoxEntity(TheAbyss instance) {
		super(instance, 397);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HyliaFoxRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764109, -16724839, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("hylia_fox_spawn_egg"));
	}
