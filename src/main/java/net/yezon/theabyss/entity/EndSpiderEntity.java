...
import net.yezon.theabyss.entity.renderer.EndSpiderRenderer;
...
public class EndSpiderEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764109, -16764109, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("end_spider_spawn_egg"));
	}
	...
	public static class CustomEntity extends EndermanEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(NetherNuggetItem.block));
		}
