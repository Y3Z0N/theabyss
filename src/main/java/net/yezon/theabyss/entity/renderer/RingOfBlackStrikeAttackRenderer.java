...
@OnlyIn(Dist.CLIENT)
public class RingOfBlackStrikeAttackRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RingOfBlackStrikeAttackItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<RingOfBlackStrikeAttackItem.ArrowCustomEntity> {
		...
		@Override
		public void render(RingOfBlackStrikeAttackItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(RingOfBlackStrikeAttackItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
