...
@OnlyIn(Dist.CLIENT)
public class PoweredWolfRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PoweredWolfEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpowered_wolf(), 0.5f) {
					{
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("theabyss:textures/powered_wolf_glowing_layer.png")));
	...
	public static class Modelpowered_wolf extends EntityModel<Entity> {
