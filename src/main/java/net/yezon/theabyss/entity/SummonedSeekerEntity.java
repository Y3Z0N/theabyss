...
import net.yezon.theabyss.entity.renderer.SummonedSeekerRenderer;
...
public class SummonedSeekerEntity extends TheAbyss.Processor {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.7999999999999999f, 2f)).build("summoned_seeker").setRegistryName("summoned_seeker");
	public SummonedSeekerEntity(TheAbyss instance) {
		super(instance, 1196);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SummonedSeekerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("summoned_seeker_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				SummonedSeekerOnEntityTickUpdateEvent.executeEvent($_dependencies);
			}
		}
	}
}
