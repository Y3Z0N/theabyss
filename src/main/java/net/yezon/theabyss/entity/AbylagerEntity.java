...
import net.yezon.theabyss.entity.renderer.AbylagerRenderer;
...
public class AbylagerEntity extends TheAbyss.Processor {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -16764109, new Item.Properties().group(TheAbyssEntityItemGroup.tab))
				.setRegistryName("abylager_spawn_egg"));
	}
