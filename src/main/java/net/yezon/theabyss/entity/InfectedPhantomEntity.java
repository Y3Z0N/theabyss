...
public class InfectedPhantomEntity extends Monster implements RangedAttackMob {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = InfectedPhantomEntity.this.getRandom();
	...
	public static void init() {
		SpawnPlacements.register(TheabyssModEntities.INFECTED_PHANTOM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
