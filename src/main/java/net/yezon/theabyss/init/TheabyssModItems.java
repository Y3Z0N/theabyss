...
import net.yezon.theabyss.item.essence.PhantomEssenceItem;
...
import net.yezon.theabyss.item.essence.BottleOfSomniumItem;
...
import net.yezon.theabyss.item.essence.AntiInfectEssenceItem;
import net.yezon.theabyss.item.essence.AntiFearEssenceItem;
...
public class TheabyssModItems {
	...
	public static final RegistryObject<Item> FUSION_AXE = REGISTRY.register("fusion_axe", () -> new FusionAxeItem());
	public static final RegistryObject<Item> FUSION_SHOVEL = REGISTRY.register("fusion_shovel", () -> new FusionShovelItem());
	public static final RegistryObject<Item> FUSION_HOE = REGISTRY.register("fusion_hoe", () -> new FusionHoeItem());
	public static final RegistryObject<Item> INCORYTHE_PICKAXE = REGISTRY.register("incorythe_pickaxe", () -> new IncorythePickaxeItem());
	public static final RegistryObject<Item> INCORYTHE_AXE = REGISTRY.register("incorythe_axe", () -> new IncorytheAxeItem());
	public static final RegistryObject<Item> INCORYTHE_SHOVEL = REGISTRY.register("incorythe_shovel", () -> new IncorytheShovelItem());
	public static final RegistryObject<Item> INCORYTHE_HOE = REGISTRY.register("incorythe_hoe", () -> new IncorytheHoeItem());
	public static final RegistryObject<Item> PHANTOM_PICKAXE = REGISTRY.register("phantom_pickaxe", () -> new PhantomPickaxeItem());
	public static final RegistryObject<Item> PHANTOM_AXE = REGISTRY.register("phantom_axe", () -> new PhantomAxeItem());
	public static final RegistryObject<Item> PHANTOM_SHOVEL = REGISTRY.register("phantom_shovel", () -> new PhantomShovelItem());
	public static final RegistryObject<Item> PHANTOM_HOE = REGISTRY.register("phantom_hoe", () -> new PhantomHoeItem());
	public static final RegistryObject<Item> GARNITE_PICKAXE = REGISTRY.register("garnite_pickaxe", () -> new GarnitePickaxeItem());
	public static final RegistryObject<Item> GARNITE_AXE = REGISTRY.register("garnite_axe", () -> new GarniteAxeItem());
	public static final RegistryObject<Item> GARNITE_SHOVEL = REGISTRY.register("garnite_shovel", () -> new GarniteShovelItem());
	public static final RegistryObject<Item> GARNITE_HOE = REGISTRY.register("garnite_hoe", () -> new GarniteHoeItem());
	public static final RegistryObject<Item> UNORITHE_PICK_AXE = REGISTRY.register("unorithe_pick_axe", () -> new UnorithePickAxeItem());
	...
	public static final RegistryObject<Item> KNIGHT_HOE = REGISTRY.register("knight_hoe", () -> new KnightHoeItem());
	...
	public static final RegistryObject<Item> ABERYTHE_AXE = REGISTRY.register("aberythe_axe", () -> new AberytheAxeItem());
	...
	public static final RegistryObject<Item> CRIMSON_POWDER = REGISTRY.register("crimson_powder", () -> new CrimsonPowderItem());
	public static final RegistryObject<Item> ENDER_POWDER = REGISTRY.register("ender_powder", () -> new EnderPowderItem());
	public static final RegistryObject<Item> FEAR_POWDER = REGISTRY.register("fear_powder", () -> new FearPowderItem());
	public static final RegistryObject<Item> ARDOR_POWDER = REGISTRY.register("ardor_powder", () -> new ArdorPowderItem());
	public static final RegistryObject<Item> TENEBRIS_POWDER = REGISTRY.register("tenebris_powder", () -> new TenebrisPowderItem());
	public static final RegistryObject<Item> FROST_POWDER = REGISTRY.register("frost_powder", () -> new FrostPowderItem());
	public static final RegistryObject<Item> HOLLOW_POWDER = REGISTRY.register("hollow_powder", () -> new HollowPowderItem());
	public static final RegistryObject<Item> VIT_POWDER = REGISTRY.register("vit_powder", () -> new VitPowderItem());
	public static final RegistryObject<Item> WARPED_POWDER = REGISTRY.register("warped_powder", () -> new WarpedPowderItem());
	public static final RegistryObject<Item> ENDER_CRYSTAL_SHARD = REGISTRY.register("ender_crystal_shard", () -> new EnderCrystalShardItem());
	public static final RegistryObject<Item> CRIMSON_CRYSTAL_SHARD = REGISTRY.register("crimson_crystal_shard", () -> new CrimsonCrystalShardItem());
	public static final RegistryObject<Item> FROST_CRYSTAL_SHARD = REGISTRY.register("frost_crystal_shard", () -> new FrostCrystalShardItem());
	public static final RegistryObject<Item> WARPED_CRYSTAL_SHARD = REGISTRY.register("warped_crystal_shard", () -> new WarpedCrystalShardItem());
	public static final RegistryObject<Item> ABYSS_CRYSTAL_SHARD = REGISTRY.register("abyss_crystal_shard", () -> new AbyssCrystalShardItem());
	public static final RegistryObject<Item> HOLLOW_CRYSTAL_SHARD = REGISTRY.register("hollow_crystal_shard", () -> new HollowCrystalShardItem());
	public static final RegistryObject<Item> CAVERNA_CRYSTAL = REGISTRY.register("caverna_crystal", () -> new CavernaCrystalItem());
	public static final RegistryObject<Item> AUREL_CRYSTAL_SHARD = REGISTRY.register("aurel_crystal_shard", () -> new AurelCrystalShardItem());
	public static final RegistryObject<Item> THUNDER_DUST = REGISTRY.register("thunder_dust", () -> new ThunderDustItem());
	public static final RegistryObject<Item> THUNDER_NUGGET = REGISTRY.register("thunder_nugget", () -> new ThunderNuggetItem());
	public static final RegistryObject<Item> VITAE_STONE = REGISTRY.register("vitae_stone", () -> new VitaeStoneItem());
	public static final RegistryObject<Item> ANIMA_DUST = REGISTRY.register("anima_dust", () -> new AnimaDustItem());
	public static final RegistryObject<Item> ANIMA_NUGGET = REGISTRY.register("anima_nugget", () -> new AnimaNuggetItem());
	public static final RegistryObject<Item> VITAE_DUST = REGISTRY.register("vitae_dust", () -> new VitaeDustItem());
	public static final RegistryObject<Item> VITAE_NUGGET = REGISTRY.register("vitae_nugget", () -> new VitaeNuggetItem());
	public static final RegistryObject<Item> THUNDER_STONE = REGISTRY.register("thunder_stone", () -> new ThunderStoneItem());
	public static final RegistryObject<Item> FUSION_ORE = block(TheabyssModBlocks.FUSION_ORE, TheabyssModTabs.TAB_THE_ABYSS);
	public static final RegistryObject<Item> ICORA_NUGGET = REGISTRY.register("icora_nugget", () -> new IcoraNuggetItem());
	public static final RegistryObject<Item> ICORA_STONE = REGISTRY.register("icora_stone", () -> new IcoraStoneItem());
	...
	public static final RegistryObject<Item> FUSION_INGOT = REGISTRY.register("fusion_ingot", () -> new FusionIngotItem());
	public static final RegistryObject<Item> PHANTOM_INGOT = REGISTRY.register("phantom_ingot", () -> new PhantomIngotItem());
	...
	public static final RegistryObject<Item> GROUND_LANDS = REGISTRY.register("ground_lands", () -> new TheAbyssDimGroundlandsItem());
